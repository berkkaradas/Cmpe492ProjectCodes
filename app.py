...
from mood_detection import detect_mood, random_music_picker, music_artist_finder, music_link_finder
import hashlib
import requests

# PATH = "C:\\İndirilenler\\bear_s_computer\\Downloads"
PATH = "D:\\İndirilenler"
...
def welcome_page():
    ...
    # user submitted signin btn
        ...
        email = request.form.get("email")
        # hashing with sha256 to the password
        password = hashlib.sha256(request.form.get("password").encode('utf-8')).hexdigest()
        ...
        if request.method == "GET":
            ...
            # user did not like recommended music
                ...
                try:
                    ...
                    music_artist = music_artist_finder(music_name=music_name)
                    music_link = music_link_finder(music_name=music_name)
                    response = make_response(
                        render_template("homepage/homepage.html", music_name=music_name, music_artist=music_artist,
                                        person_mood=person_mood, music_link=music_link)
                    )
                    ...
                    return render_template("homepage/homepage.html", music_name=error,
                                           music_artist="We will recommend you your music!",
                                           person_mood="Let's find your mood")
    except Exception as error:
        return render_template("homepage/homepage.html", music_name=error,
                               music_artist="We will recommend you your music!", person_mood="Let's find your mood")
